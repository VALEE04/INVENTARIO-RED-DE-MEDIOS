...
<center><br><h1>Lista de Nodos</h1><br></center>
...
<div class="container-fluid">
    <form action="<?=$_SERVER['PHP_SELF']?>" method="post">
        ...
        <input class="btn btn-outline-info" type="hidden" name="enviar">
                ...
                <a href="lista_nodos.php"> <button class="btn btn-outline-info" type="submit" name=""  >Mostrar todos los datos</button></a><br><br>
                <a href="nuevo_nodo.php"> <button type="button" class="btn btn-outline-info" style="  margin-right:-100px; "  >Añadir </button></a>
...
<table class="table table-bordered">
  ...
  <tbody>
  	...
  	if (isset($_POST['enviar'])) {
  		...
  		$sql="SELECT * FROM nodo WHERE nodos LIKE '%".$buscador."%'";
      ...
      <td>
      <a href="ListaNodos/eliminar_nodos.php?id=<?php echo $row['nodos']?>" class="btn btn-danger" onclick="return confirmDelete()" >Eliminar</a>
      </td>
    </tr>
<?php
 }
