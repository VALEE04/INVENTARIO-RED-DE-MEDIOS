                ...
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item active">
                        <div class="menunavegacion">
                            ...
                            <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">    
                            <a class="dropdown-item" href="../Nodos/nuevo_nodo.php?vista=user_new">Nuevo</a>
                            <a class="dropdown-item" href="../Nodos/listas_nodos.php?vista=user_list">Listas</a>
                            </div>
                        </div>
                    </li>
...
<div class="container">
  <div class="page-header">
  	<br>	
    <h1 class="h3">Nuevo Nodo 
  </div>
  <form action="" method="post" >
    <br>
    <table class="table table-bordered table-responsive">
    	<input type="hidden" name="id_nodo">
        <br>
      <tr>
        <td><label class="control-label">Nombre del nodo:</label></td>
        <td><input class="form-control" type="text" name="nodo" align="center" placeholder="Nombre del nodo" required></td>
      </tr>
...
if (isset($_POST['register'])) {
    if (strlen($_POST['nodo']) >= 1){ 
        ...
        $nodos = trim($_POST['nodo']);
        $consulta = "INSERT INTO nodo (nodos) VALUES ('$nodos')";
$resultado = mysqli_query($con,$consulta);

if ($resultado) { 

    ?>
echo'<script type="text/javascript"> alert("SE REGISTRO EL NODO CON EXITO!")</script>';
            echo "<script> window.location.href = 'lista_nodos.php';</script>";
            //header("location: cate_nuevo.php");
        }else{
            echo'<script type="text/javascript"> alert("NO SE REGISTRO EL NODO")</script>';
            echo "<script> window.location.href = 'lista_nodos.php';</script>";
            //echo "No se registro";
        }
