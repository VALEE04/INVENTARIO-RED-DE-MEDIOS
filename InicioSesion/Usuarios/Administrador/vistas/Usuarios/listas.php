...
<head>
    ...
    <script type="text/javascript">
		...
		function alertActualizacion() {
             var respuesta = alert("Para actualizar el usuario, verifica que las contraseñas sean iguales");
            }
	</script>
	 <!-- PLUGINS ALERTA -->
...
<div class="container-fluid">
	<form action="<?=$_SERVER['PHP_SELF']?>" method="post">
		...
		<input class="btn btn-outline-info" type="hidden" name="enviar">
				...
				<a href="../Usuarios/pdf" <button class="btn btn-outline-info" type="submit"  name="">Generar Reporte</button></a>
	</form>
</div>
...
<table class="table table-bordered">
  ...
  <tbody>
  	...
  	if (isset($_POST['enviar'])) {
  		...
  		$sql="SELECT * FROM usuarios WHERE nombreUsuario LIKE '%".$buscador."%' OR apellidoUsuario LIKE '%".$buscador."%' OR emailUsuario LIKE '%".$buscador."%' OR ID_CARGO LIKE '%".$buscador."%' OR usuarioUsuario LIKE '%".$buscador."%'  ";
      ...
      <td>
      <a href="actualizar_u.php?id=<?php echo $row['idUsuario']?>" class="btn btn-primary" onclick="alertActualizacion()">Editar</a>
      <a href="ListasUsuario/eliminar_usuario.php?id=<?php echo $row['nombreUsuario']?>" class="btn btn-danger" onclick="return confirmDelete()" >Eliminar</a>
      </td>
    </tr>
<?php
 }
    ...
    <tr>
      ...
      <td><?php echo $row['emailUsuario']?></td>
      <td>
      <a href="actualizar_u.php?id=<?php echo $row['nombreUsuario']?>" class="btn btn-primary">Editar</a>
      <a href="ListasUsuario/eliminar_usuario.php?id=<?php echo $row['nombreUsuario']?>" class="btn btn-danger" onclick="return confirmDelete()">Eliminar</a>
      </td>
    </tr>
    <?php
