...
<div class="container">
  <div class="page-header">
    <h1 class="h3">Nuevo Encargado <a class="btn btn-secondary" href="listas_encargados.php"> <span class="glyphicon glyphicon-eye-open"></span>  Mostrar todo</a></h1>
  </div>
  <form action="../../php/guardar_encargados.php" method="post" enctype="multipart/form-data" class="form-horizontal">
    <table class="table table-bordered table-responsive">
    	<input type="hidden" name="ID_ENCARGADO">
      <tr>
        <td><label class="control-label">Nombre Completo:</label></td>
        <td><input class="form-control" type="text" align="center" placeholder="Nombre Completo" name="NOMBRE_ENCARGADO" required ></td>
      </tr>
	  <tr>
	  ...
	  <tr>
        ...
        <td><input class="form-control" type="email" align="center" placeholder="Correo Electronico" name="email"  required ></td>
      </tr>
      ...
      <tr>
        ...
        <td><input class="form-control" type="text" align="center" placeholder="Numero de Documento" name="numero_documento" maxlength="70" required ></td>
      </tr>

      <tr>
        <td><label class="control-label">Lugar de sede:</label></td>
        <td><input class="form-control" type="text" align="center" placeholder="Lugar Sede" name="lugar_sede"  required ></td>
      </tr>

      <tr>
        <td><label class="control-label">Telefono:</label></td>
        <td><input class="form-control" type="text" align="center" placeholder="Telefono" name="telefono"  required ></td>
      </tr>
      <tr>
