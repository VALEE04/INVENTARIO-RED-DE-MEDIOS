...
<div class="container-fluid">
    <form action="<?=$_SERVER['PHP_SELF']?>" method="post">
        ...
        <input class="btn btn-outline-info" type="hidden" name="enviar">
                ...
                <a href="listas_cables.php"> <button class="btn btn-outline-info" type="submit" name=""  >Mostrar todos los datos</button></a><br><br>
                <a href="../Cables/pdf" <button class="btn btn-outline-info" type="submit"  name="" style=" margin-right:850px; ">Generar Reporte</button></a>
                            <a href="registrar_cables.php"> <button type="button" class="btn btn-outline-info" style="  margin-right:-100px; "  >Añadir </button></a>
