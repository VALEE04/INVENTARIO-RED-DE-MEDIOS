...
if (isset($_POST['btnsave'])) {
    ...
    $upload_dir = $_SERVER['DOCUMENT_ROOT'] . '/Inventario/InicioSesion/Usuarios/Delegados/vistas/MOBILIARIO/imagenes/';
        ...
        if (in_array($imgExt, $valid_extensions)) {
            if ($imgSize < 1000000) {
                if (move_uploaded_file($tmp_dir, $upload_dir . $userpic)) {
                    ...
                    $errMSG = "Error al mover la imagen al directorio de destino.";
                }
            } else {
...
<?php
ob_end_flush(); // Envía la salida almacenada en el búfer
?>
</body>
</html>
