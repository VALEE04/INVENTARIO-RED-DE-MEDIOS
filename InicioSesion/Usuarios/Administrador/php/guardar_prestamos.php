...
$ID_FECHA = isset($_POST['ID_FECHA']) ? $_POST['ID_FECHA'] : null;
$ID_ALMACENADO = isset($_POST['ID_ALMACENADO']) ? $_POST['ID_ALMACENADO'] : null;
$FECHA_ENTREGA = isset($_POST['FECHA_ENTREGA']) ? $_POST['FECHA_ENTREGA'] : null;
$ESTADO_ENTREGA = isset($_POST['ESTADO_ENTREGA']) ? $_POST['ESTADO_ENTREGA'] : null;
$FECHA_SALIDA = isset($_POST['FECHA_SALIDA']) ? $_POST['FECHA_SALIDA'] : null;
$ESTADO_SALIDA = isset($_POST['ESTADO_SALIDA']) ? $_POST['ESTADO_SALIDA'] : null;
$NOMBRE_ENCARGADO = isset($_POST['NOMBRE_ENCARGADO']) ? $_POST['NOMBRE_ENCARGADO'] : null;
$ROL = isset($_POST['ROL']) ? $_POST['ROL'] : null;
$nodo = isset($_POST['Nodos']) ? $_POST['Nodos'] : null;
