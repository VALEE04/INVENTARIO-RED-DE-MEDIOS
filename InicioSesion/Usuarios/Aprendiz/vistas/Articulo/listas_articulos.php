            ...
            <div class="collapse navbar-collapse" id="navbarNavDropdown">
                <ul class="navbar-nav">
                    ...
                    <a class="nav-link dropdown-toggle" href="#" id="navbarDropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Prestamos</a>
                        <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                            <a class="dropdown-item" href="../Prestamos/listas_prestamos.php?vista=user_list">Prestamos</a>                        </div>
...
<table class="table table-bordered">
  ...
  <tbody>
  	...
  	if (isset($_POST['enviar'])) {
  		...
  		$sql="SELECT * FROM articulos WHERE REFERENCIASERIAL LIKE '%".$buscador."%' OR NOMBRE_MARCA LIKE '%".$buscador."%' OR FECHA_REVISION LIKE '%".$buscador."%' OR NOMBRE_ENCARGADO LIKE '%".$buscador."%' OR ROL LIKE '%".$buscador."%'  ";
