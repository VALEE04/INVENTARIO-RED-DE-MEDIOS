...
<div class="container-fluid">
    <form action="<?=$_SERVER['PHP_SELF']?>" method="post">
        ...
        <input class="btn btn-outline-info" type="hidden" name="enviar">
                ...
                <a href="listas_almacenados.php"> <button class="btn btn-outline-info" type="submit" name=""  >Mostrar todos los datos</button></a><br><br>
...
<table class="table table-bordered">
  ...
  <tbody>
  	...
  	if (isset($_POST['enviar'])) {
  		...
  		$sql="SELECT * FROM almacenado WHERE NOMBRE_ALMACENADO LIKE '%".$buscador."%' OR CATEGORIA_NOMBRE LIKE '%".$buscador."%' OR SERIAL_ALMACENADO LIKE '%".$buscador."%' OR CANTIDAD_ALMACENADO LIKE '%".$buscador."%' OR nodos LIKE '%".$buscador."%'   ";
    ...
    <tr>
      ...
      <td><?php echo $row['SERIAL_ALMACENADO']?></td>
      <td><?php echo $row['CANTIDAD_ALMACENADO']?></td>
      <td><?php echo $row['OBSERV_ALMACENADO']?></td>
